<template>
    <div>
        <div class="container email-signup">
            ...
            <div class="row">
                <div class="col-lg">
                    Sign up with your email address to receive an update when a new piece arrives!
                </div>
            </div>
            <div class="row">
                <div class="col-lg">
