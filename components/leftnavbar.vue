<template>
    <div>
        ...
        <div style="padding-bottom: 50px; padding-top: 30px">
            ...
            <nuxt-link class="menu-item" :to="`/`">commission</nuxt-link><br>
            <nuxt-link class="menu-item" :to="`/`">portfolio</nuxt-link><br>
        </div>
        <div style="padding-bottom: 70px">
            <nuxt-link class="menu-item" :to="`/`">blog</nuxt-link><br>
            <nuxt-link class="menu-item" :to="`/`">contact</nuxt-link><br>
        </div>
        <div align="center">
